...
Random seed & 42 & Split reproducibility \\
...
Future work should tune hyperparameters with cross-validation, clip predicted scores to the 1--5 range, and join movie titles to internal item indexes in recommendation exports for readability. Incorporating movie metadata could also reduce item cold-start error~\cite{ref4,ref10}.
